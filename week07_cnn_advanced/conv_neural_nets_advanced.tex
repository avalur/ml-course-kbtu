...
\note{Hello, today we continue to talk about Convolutional Neural Networks, advanced optimization methods ans architecture.
...
\frametitle{Regularization Methods}
   ...
   \note{Dropout is a method of random shutdowns of neurons. It may have two stages: learning stage and application stage.}
